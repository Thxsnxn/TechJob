    ...
    <main className="">
      ...
      <section className="p-6 space-y-4">
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
          ...
          <Link href="/jobmanagement/add" className="w-full md:w-[300px]">
            <Button className="bg-blue-600 w-full h-auto md:h-[60px] text-lg md:text-2xl py-3 hover:bg-blue-700 text-white">
              + Create New Job
            </Button>
          </Link>
        </div>
      ...
      {/* create now navigates to /jobmanagement/add */}
    </main>
  )
}
