...
const ProfilePage = () => {
  const [about, setAbout] = useState(
    "67107666 Sripatum University | Bachelor of Science (Computer Science and Software Development Innovation)"
  );
      ...
      <main className="px-5 pb-24">
        ...
        <div className="mt-6 space-y-4">
          <div>
            ...
            <div className="rounded-lg border px-3 py-2 shadow-sm bg-white">
              กิตติวัฒน์
            </div>
          </div>
          ...
          <div>
            ...
            <div className="relative">
              <textarea
                className="rounded-lg border px-3 py-2 shadow-sm bg-white w-full"
                value={about}
                onChange={(e) => {
              ...
              {isEditing && (
                <button
                  onClick={handleSave}
                  className="absolute -right-2 -top-2 bg-blue-500 text-white rounded-full p-2 shadow-lg hover:bg-blue-600 transition-colors"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="h-4 w-4"
