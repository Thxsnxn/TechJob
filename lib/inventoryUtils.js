...
// ==========================================
// 2. STOCK DATA (80+ รายการ)
// ==========================================

/**
 * @typedef {'Returnable' | 'Consumable'} ItemType
 * @typedef {Object} StockItem
 * @property {string} itemCode - รหัสสินค้า
 * @property {string} itemName - ชื่อสินค้า
 * @property {string} category - หมวดหมู่สินค้า
 * @property {ItemType} itemType - ประเภท (เบิกคืนได้/สิ้นเปลือง)
 * @property {string} supplierName - ชื่อผู้จำหน่าย
 * @property {number} stock - จำนวนคงเหลือ
 * @property {string} unit - หน่วยสินค้าหลัก
 * @property {number} packSize - ขนาดบรรจุ (จำนวนหน่วยต่อหนึ่งหน่วยบรรจุ)
 * @property {string} unitPkg - หน่วยบรรจุย่อย (เช่น 'ตัว' ใน 'ถุง')
 */
